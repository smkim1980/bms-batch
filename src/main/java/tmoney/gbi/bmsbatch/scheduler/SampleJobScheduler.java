package tmoney.gbi.bmsbatch.scheduler;
...
import tmoney.gbi.bmsbatch.config.BatchJobRunner;

import java.util.Map;

import static tmoney.gbi.bmsbatch.common.util.JobSchedulerUtil.currentMethodName;
import static tmoney.gbi.bmsbatch.common.util.JobSchedulerUtil.getJobName;
...
//    }
    ...
    public void runJobEvery10Seconds() {
        // 공통 러너를 사용하여 Job 실행
       batchJobRunner.runJob(jobMap.get(getJobName(JobNames.BMS_TXT_JOB)), currentMethodName());
    }
